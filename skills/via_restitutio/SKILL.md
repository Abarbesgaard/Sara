...
1. **Lex Munditiae** — remove scratch probes, temp files, and test containers that are not part of the fix (`docker compose down`, remove throwaway scripts, etc.).
1. **Record** — `sara learn` the root cause and the alignment made.
